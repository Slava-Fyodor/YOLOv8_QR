...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Разработка интеллектуальной системы автоматического распознавания QR-кодов на основе модели YOLOv8 с графическим интерфейсом PyQt5")
        ...
        self.tab_widget.addTab(self.inference_tab, "Распознавание")  # 推理
        self.tab_widget.addTab(self.settings_tab, "Настройки")  # 设置
